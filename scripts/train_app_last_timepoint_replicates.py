#!/usr/bin/env python3
"""
Train APP treatment replicate using only last timepoints (T14 for 0ms, T15 for 10000ms).
"""
import sys
...
print(f"\n{'='*80}")
print(f"TRAINING APP TREATMENT REPLICATE {replicate_id:02d} (LAST TIMEPOINT ONLY)")
print(f"Seed: {seed}")
print(f"{'='*80}\n")
...
# Load datasets
train_csv = 'A2screen_combined/data/app_treatment_LAST_TIMEPOINT/train.csv'
val_csv = 'A2screen_combined/data/app_treatment_LAST_TIMEPOINT/val.csv'
test_csv = 'A2screen_combined/data/app_treatment_LAST_TIMEPOINT/test.csv'
...
# Callbacks
output_dir = f'A2screen_combined/models/app_treatment_LAST_TIMEPOINT_replicates/replicate_{replicate_id:02d}'
